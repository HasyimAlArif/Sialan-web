            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-blue-50/50 transition duration-150 group">
                        ...
                        <td class="p-4 text-center">
                            @if($l->foto)
                                <img src="{{ asset('storage/' . $l->foto) }}" alt="Foto Kerusakan" class="w-16 h-12 object-cover rounded-md shadow-sm border border-gray-200 mx-auto hover:scale-125 transition-transform duration-300">
                            @else
